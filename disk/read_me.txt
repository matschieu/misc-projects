...
MAKEFILE :
* make compile l'ensemble des exécutables puis nettoie tous les fichiers .o 
(appel à make clean).
* make clean permet de nettoyer les fichiers .o.
* make cleanexec permet de nettoyer tous les exécutables et fichiers .o
* make realclean permet de nettoyer l'ensemble des fichiers .o, les exécutables 
et les fichiers représentant les disques durs créés par l'exécution des 
programmes.
